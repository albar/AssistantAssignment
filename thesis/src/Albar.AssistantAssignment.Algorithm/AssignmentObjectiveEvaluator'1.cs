...
{
    public class AssignmentObjectiveValuesEvaluator<T> : IObjectiveValuesEvaluator<T>, IEnumerable<KeyValuePair<T, IObjectiveEvaluator<T>>> where T : Enum
    {
        ...
        public ObjectiveValues<T> Evaluate(IChromosome<T> chromosome)
        {
