...
namespace Thesis.Database
{
    public class DatabaseContext : DbContext
    {
        ...
        public DbSet<Entity.Assistant> Assistants { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Subject>()
                ...
                .HasConversion(
                    ...
                    threshold => JsonConvert.DeserializeObject<Dictionary<Thesis.DataType.Assesments, double>>(threshold)
                );
            ...
            modelBuilder.Entity<AssistantSubject>()
                ...
                .HasConversion(
                    ...
                    str => JsonConvert.DeserializeObject<Dictionary<Thesis.DataType.Assesments, double>>(str)
                );
